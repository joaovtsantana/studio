...
const navItems = [
  ...
  { href: '/dashboard/data', icon: BarChart3, label: 'Environmental Data' },
  { href: '/dashboard/forum', icon: MessagesSquare, label: 'Community Forum' },
  { href: '/dashboard/resources', icon: BookOpen, label: 'Tips & Resources' },
];
